...
import { MapPin, Users, Wifi, Coffee, Music, ParkingMeter as Parking } from 'lucide-react';
...
const venues = [
  {
    ...
    description: 'A state-of-the-art outdoor venue perfect for concerts and festivals.',
  },
  {
    id: 2,
    ...
    description: 'An iconic indoor venue known for its perfect acoustics and elegant atmosphere.',
  },
  {
    id: 3,
    name: 'Riverside Stadium',
    image: 'https://images.unsplash.com/photo-1507666664345-c49223375e33?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
    location: 'Queens, NY',
    capacity: '25,000',
    amenities: ['Multiple Stages', 'Food Vendors', 'First Aid', 'Security'],
    description: 'A massive outdoor venue hosting the biggest events in the city.',
  },
];
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600">Discover world-class venues for unforgettable events</p>
      </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {venue.amenities.map((amenity) => (
                    <div key={amenity} className="flex items-center text-gray-600">
                      ...
                      {amenity === 'Food Court' && <Coffee className="h-4 w-4 mr-1" />}
                      {amenity === 'Premium Sound' && <Music className="h-4 w-4 mr-1" />}
                      {amenity === 'Parking' && <Parking className="h-4 w-4 mr-1" />}
      ...
      <div className="mt-16 bg-indigo-50 rounded-xl p-8 text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Looking for a Venue?</h2>
        <p className="text-gray-600 mb-6">
          We can help you find the perfect venue for your event. Contact our venue specialists for personalized assistance.
        </p>
